...
<html lang="fr">
	...
	<?php if(isset($_GET["error"])){
		...
		if($msg=="connexion-necessaire"){
			echo "<h3> Vous devez être connecté pour accéder à ce contenu ! <br> Merci de vous identifier </h3>";
			echo "<style> h3{ text-align:center; color:red; } </style>";
		}
	}
	?>
